...
export default function dataReducer(state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case "CHANGE_QUERIES_DROPDOWN":
      let dropDownqueries = newState.queries;
      dropDownqueries = dropDownqueries.filter(
        (dropDownquery) => dropDownquery !== action.value
      );
      newState.queries = dropDownqueries;
      return {
        ...newState,
      };
